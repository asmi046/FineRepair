<div class="main__saleform mobile">
    <section class="mainSaleform flex flex--aic flex--jcsb" data-sale="30%">
        ...
        <form method="POST" class="mainSaleform__right">
            <input type="text" name="phone" class="mainSaleform__field phoneField" required="required"
                   placeholder="+7 (___) ___-__-__">
            <button class="mainSaleform__bttn Bttn Bttn--black">Вызвать мастера</button>
        </form>
    </section>
</div>